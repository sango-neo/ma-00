...
export function HeaderFin() {
  return (
    ...
    >
      <div className="px-[5%] lg:px-0 sm:max-w-md sm:mx-auto text-center lg:text-start  md:justify-self-start lg:ml-[5vw] lg:mr-20 lg:justify-self-end">
        ...
        >
          <div className="mt-6 flex flex-wrap gap-4 md:mt-8">
            <a href="#section-one" className="ma-primary-btn md:w-full lg:w-fit bg-ma_darkBlue">Learn more &nbsp; <span>
